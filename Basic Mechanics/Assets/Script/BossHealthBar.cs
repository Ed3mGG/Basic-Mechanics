...
public class BossHealthBar : MonoBehaviour
{
    ...
    public void SetMaxHealth(int health) // Initialisation de la barre d'HP au max en lan�ant le jeu
    {
    ...
    public void SetHealth(int health) // Indique � la barre d'HP le nombre de pdv � afficher
    {
        slider.value = health;
